...
public abstract class AbstractCommand implements IPlayerCommand
{

	protected CommandFlags flags;
	protected HexMapCommand hexmapCmd;
	protected DungeonCommand dngCmd;

	public AbstractCommand(HexMapCommand hmc, CommandFlags cFlags)
	{
		this.hexmapCmd = hmc;
		if (cFlags != null)
		{
		...
		{
			this.flags = new CommandFlags(); // initialize new flags object
		}
	}
	...
	@Override
	public DungeonCommand getCommand()
	{
		return this.dngCmd;
	}
}
