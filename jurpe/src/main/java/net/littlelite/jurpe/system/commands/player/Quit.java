...
public class Quit extends AbstractCommand implements IPlayerCommand
{
	public Quit(HexMapCommand hmc, CommandFlags flags)
	{
		super(hmc, flags);
		this.generate();
	}
	...
	{
		this.dngCmd = new DungeonCommand(PlayerCommand.QUITGAME, "Quit the game?");
	}
}
