...
public class FirstAid extends AbstractCommand implements IPlayerCommand
{

	public FirstAid(HexMapCommand hmc, CommandFlags flags)
	{
		super(hmc, flags);
		this.generate();
	}
	...
	{
		this.dngCmd = new DungeonCommand(PlayerCommand.USEFIRSTAID, LibraryStrings.TRYFIRSTAID);
	}
