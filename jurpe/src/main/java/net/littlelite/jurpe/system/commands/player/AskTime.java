...
public final class AskTime extends AbstractCommand implements IPlayerCommand
{

	public AskTime(HexMapCommand hmc, CommandFlags flags, GameWorld gw)
	{
		super(hmc, flags);
		this.generate(gw);
	}

	private void generate(GameWorld gw)
	{
		this.dngCmd = new DungeonCommand(PlayerCommand.SAYTIME, gw.getGameTime().whatTimeIsIt());
	}
