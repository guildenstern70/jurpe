 ...
 * 
 */
public abstract class AbstractItem implements Cloneable, Serializable, Comparable<AbstractItem>
{
	 ...
	 * 
	 * @param itemType
	 *            Describes item type. Use AbstractItem.WEAPON, AbstractItem.ARMOR,
	 *            AbstractItem.SHIELD, AbstractItem.OTHER or AbstractItem.ITEM
	 * @param oNome
	 *            Name of object
	 * @param oCosto
	 *            Cost of object
	 ...
	 *            Weight of object
	 */
	public AbstractItem(ItemType itemType, String oNome, int oCosto, int oPeso)
	{
		type = itemType;
		name = oNome;
		cost = oCosto;
	 ...
	 */
	public AbstractItem(ItemType itemType, String oNome, int oCosto, int oPeso, boolean usable, boolean wearable)
	{
	...
	/**
	 * Return true if the character specified can wear the item
	 * (ie, has the required strength to lift the mace)
	 * @param character that must wear the item
	 * @return true if the character specified can wear the item
	 */
	public boolean canBeWorn(AbstractPC character)
	{
		return true; // must be overridden
	}

	/**
	 * Returns type of item, such as: AbstractItem.WEAPON, AbstractItem.ARMOR,
	 * AbstractItem.SHIELD, AbstractItem.OTHER or AbstractItem.ITEM.
	 * 
	 * @return type of item.
	 */
	 ...
	 * Notice that this is true when the item is to be used,
	 * even if the character in that moment of the game cannot use it.
	 * 
     ...
     * Notice that this is true when the item is to be worn,
	 * even if the character in that moment of the game cannot wear it,
	 * ie: he has not the required strength 
	 * 
	...
	/**
	 * Every time an AbstractItem needs to send a message back, this field can be
	 * used.
	 * 
	...
	/**
	 * Returns cost and weight of an AbstractItem. (Every object MUST have a cost
	 ...
	 * @return true if character correctly wore AbstractItem
	 */
	 ...
	 */
	public int compareTo(AbstractItem rv)
	{
		int rvCosto = rv.cost;
